    ...
    OperationResponse<List<GetAllChallengesQuery.Response>>>
{
    ...
    public async Task<OperationResponse<List<GetAllChallengesQuery.Response>>> HandleAsync(
        GetAllChallengesQuery.Request request,
        CancellationToken cancellationToken = new())
    {
          var challenges = await _repository.GetAsync(e => !e.UtcDateDeleted.HasValue && e.LanguageId == request.LanguageId,
