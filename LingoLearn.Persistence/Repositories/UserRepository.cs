...
public class UserRepository : LingoLearnRepository, IUserRepository
{
    ...
    public UserRepository(LingoLearnDbContext context ,IJwtService jwt,
    ...
    public async Task<IdentityResult> AddWithRole(User user, LingoLearnRoles role, string? password = null)
    {
