        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Challenges_Languages_LanguageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteLanguages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteLanguages_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LanguageUser", x => new { x.LanguagesId, x.ParticipantsId });
                    table.ForeignKey(
                        name: "FK_LanguageUser_AspNetUsers_ParticipantsId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "FavoriteLanguages",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteLanguages_UserId",
                table: "FavoriteLanguages",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LanguageUser_ParticipantsId",
                table: "LanguageUser",
